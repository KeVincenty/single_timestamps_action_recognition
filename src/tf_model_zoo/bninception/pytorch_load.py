...
# CODE COPIED AND EDITED FROM https://github.com/yjxiong/tensorflow-model-zoo.torch


class BNInception(nn.Module):
    def __init__(self, model_path='tf_model_zoo/bninception/bn_inception.yaml'):
